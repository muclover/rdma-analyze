---
name: gh-cli
description: GitHub CLI (gh) comprehensive reference for repositories, issues, pull requests, Actions, projects, releases, gists, codespaces, organizations, extensions, and all GitHub operations from the command line. In Cursor Agent, run gh with full permissions (all), not sandbox+network only.
---
...
# Set homepage
gh reepo autolink delete 12345
```
